...
export default function ResultCard({ data }: ResultCardProps) {
  return (
    <div className="flex items-center space-x-3 rounded-lg bg-white p-1 shadow-md">
      ...
      <div className="flex size-full flex-col justify-between">
        <div className="">
          ...
          <h1 className="text-sm font-bold text-slate-700">
            <a href={data.trackViewUrl} target="_blank" className="">
              {truncate(data.trackName, 50)}
            </a>
          </h1>
        </div>
        <div className="flex w-full items-center justify-between">
          ...
          <div className="flex items-center space-x-2 text-yellow-500">
            ...
            <span className="text-xs">{data.trackPrice}</span>
          </div>
        </div>
      </div>
    </div>
